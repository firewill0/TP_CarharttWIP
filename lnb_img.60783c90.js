...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"js/lnb_img.js":[function(require,module,exports) {
var lnbHover = false;
var lnbListHover = false;
var lnb_hover = document.querySelectorAll('.lnb_hover');
console.log("lnb_hover:", lnb_hover);
var lnbList = document.querySelector('.lnb_menu');
var lnbListIn = document.querySelector('.lnb_menu_in');
var lnb_img1 = document.querySelector('.lnb_img1');
var lnb_img2 = document.querySelector('.lnb_img2');
var _loop = function _loop(i) {
  ...
  lnb_hover[i].addEventListener('mouseover', function () {
    ...
    var img_path1 = "./img/lnb_img/" + i + "/1.jpg";
    var img_path2 = "./img/lnb_img/" + i + "/2.jpg";
...
for (var i = 0; i < lnb_hover.length; i++) {
  _loop(i);
}
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","js/lnb_img.js"], null)
//# sourceMappingURL=/lnb_img.60783c90.js.map