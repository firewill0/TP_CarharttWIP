...
const sub_category = myURL.get('category_sub');
...
function addItem(index) {
    ...
    if (sub_category === "all" || sub_category === undefined || sub_category === "" || sub_category === " " || sub_category === null) {
        ...
        const category = shoppingList_Top[index].category_sub;
